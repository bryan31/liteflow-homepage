...
更多配置项请参考[配置项](/pages/v2.8.X/b5065a/)章节。
...
::: tip
这个`DefaultContext`是默认的上下文，用户可以用最自己的任意Bean当做上下文传入，如果需要传入自己的上下文，则需要传用户Bean的Class属性，具体请看[数据上下文](/pages/v2.8.X/74b4bf/)这一章节。
:::
