...
异步流程的话，如果`<when>`上配置了`errorResume="true"`的话(默认就是true)，则下一个不同并行组会继续。关于`errorResume`的定义和使用，可以查看[**<font color="#ca3e66">同步&异步</font>**](/docs/user-detail-guide/user-detail-guide-condition)章节
