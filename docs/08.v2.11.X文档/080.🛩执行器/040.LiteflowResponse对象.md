...
permalink: /pages/v2.11.X/9f653d/
---
...
关于异常的解释请详细查看[异常](/pages/v2.11.X/dc9bfe/)这一章节。
...
关于这上面2个方法的区别和步骤信息的详细请参考[步骤信息](/pages/v2.11.X/e5ed0d/)。
...
这里的表达形式为`组件ID[组件别名]<耗时毫秒>`。关于如何设置组件别名可以参考[组件别名](/pages/v2.11.X/92ef89/)。
