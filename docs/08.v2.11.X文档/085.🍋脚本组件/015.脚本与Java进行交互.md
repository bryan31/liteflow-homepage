...
permalink: /pages/master/d861c8/
---

:::tip
这章只适用于groovy,js,python,qlexpress,lua,aviator这6种脚本语言。

v2.11.0新增的Java脚本语言和Java类的交互方式在[Java脚本引擎](/pages/master/2b8afb/)中已做了详细说明。
:::
...
* **nodeId:** 当前执行node的Id
* **tag:** tag值，关于tag的说明请查看[组件标签](/pages/master/0f788f/)
* **cmpData:** 组件规则参数，关于cmpData的说明请查看[组件参数](/pages/master/6e4d15/)
* **loopIndex:** 在循环中的循环下标
