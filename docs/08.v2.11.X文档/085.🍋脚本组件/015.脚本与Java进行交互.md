...
v2.11.0新增的Java脚本语言和Java类的交互方式在[Java脚本引擎](/pages/script/type/java/)中已做了详细说明。
:::
...
* **nodeId:** 当前执行node的Id
* **tag:** tag值，关于tag的说明请查看[组件标签](/pages/advance/tag/)
* **cmpData:** 组件规则参数，关于cmpData的说明请查看[组件参数](/pages/advance/cmpparam/)
* **loopIndex:** 在循环中的循环下标
