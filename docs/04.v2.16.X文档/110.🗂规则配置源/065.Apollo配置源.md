...
从 2.16.1 起我们**更推荐使用全新的 [Rule-DB 模式](/pages/ruledb-overview/)**。不过 Rule-DB 当前版本**尚未提供 Apollo 后端**，如果你使用 Apollo，请继续用本章的插件；或者改用 Rule-DB 已支持的 MySQL / PostgreSQL / MongoDB / Redis / ZooKeeper / Etcd / Nacos。
