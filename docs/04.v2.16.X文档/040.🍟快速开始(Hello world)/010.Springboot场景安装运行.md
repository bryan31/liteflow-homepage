...
:::tip Springboot 4.X用户请注意
以上的`liteflow-spring-boot-starter`适用于Springboot 2.X ~ 3.X。

如果你使用的是Springboot 4.X，请改为依赖`liteflow-spring-boot4-starter`（要求JDK17及以上），其余用法完全一致：
