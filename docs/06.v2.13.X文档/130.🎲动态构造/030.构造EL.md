...
permalink: /pages/v2.13.X/a3cb4b/
---
...
而`ELBus.node("a")`则是给节点外面套上了`node`关键字，其意义是在加载的时候不检查和降级，关于`node`关键字的详细可参考[组件名包装](/pages/v2.13.X/2df3d9/)以及[组件降级](/pages/v2.13.X/79289a/)。
