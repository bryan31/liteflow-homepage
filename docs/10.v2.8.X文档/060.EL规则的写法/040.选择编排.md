...
```
:::tip 图示
<img :src="$withBase('/img/flow_example/e6.png')" style="zoom: 25%">
:::
...
:::tip 图示
<img :src="$withBase('/img/flow_example/e7.png')" style="zoom: 25%">
:::
...
:::tip 图示
<img :src="$withBase('/img/flow_example/e9.png')" style="zoom: 25%">
:::
