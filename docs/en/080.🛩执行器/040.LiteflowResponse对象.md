...
关于异常的解释请详细查看[异常](/en/pages/advance/exception/)这一章节。
...
关于这上面2个方法的区别和步骤信息的详细请参考[步骤信息](/en/pages/advance/step/)。
...
这里的表达形式为`组件ID[组件别名]<耗时毫秒>`。关于如何设置组件别名可以参考[组件别名](/en/pages/advance/aliasname/)。
